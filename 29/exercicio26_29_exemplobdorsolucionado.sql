...
*/
select ' 9.Seleccionar o número de orde e o  coste total dos pedidos  feitos  polo cliente numero 3.' from dual;
select o.ordnum, o.coste_total() b from pedido_intab o where o.cliente.clinum=3;
